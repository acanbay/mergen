...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    ────────────────────────────────────────────────────────────
      ...
      [MERGEN]   sa     done -- score=2.25  (elapsed 5.2s)
      [MERGEN]   sce    done -- score=1.665  (elapsed 1.4s)
      [MERGEN]   ese    done -- score=2.496  (elapsed 0.1s)
      [MERGEN]   Best: sce  score=1.665  (total elapsed 6.7s)
    ...
    ────────────────────────────────────────────────────
       * sce    : score=1.66482  elapsed=1.36s  n_iter=600
         sa     : score=2.24955  elapsed=5.15s  n_iter=600
         ese    : score=2.49641  elapsed=0.12s  n_iter=30
    ────────────────────────────────────────────────────
